...
\* \*\*CDC Strategy\*\*: Timestamp-based (`updated\_at`)
...
&#x20; "outputFilename": "full\_consumer-1\_timestamp.csv"
...
\* is\_deleted (Soft delete)



✔ Indexed on `updated\_at`
...
full\_consumer-1\_1710000000.csv
...
2\. Store latest `updated\_at` as watermark
...
docker exec -it <app\_container\_name> npm test
...
docker logs <app\_container\_name>
